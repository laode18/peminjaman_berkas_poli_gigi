...
<head>
    ...
    <title>Petugas - Peminjaman Berkas Poli Gigi</title>
    <!-- Favicon icon -->
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav sidebar sidebar-dark accordion" style="background: linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(43,43,255,1) 0%, rgba(0,212,255,1) 100%);" id="accordionSidebar">
            
            <!-- Sidebar - Brand -->    
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-icon rotate-n-0">
                    <img src="{{ URL::asset('landing/img/1logors.png'); }}" width="90" height="60" alt="" />
                </div>
            </a>
            <!-- Divider -->
            ...
            <li class="nav-item {{ set_active('petugas.databerkas') }}">
                <a class="nav-link <?php echo $result3['status'] ?>" href="/petugas/databerkas">
            ...
            <li class="nav-item {{ set_active(['petugas.laporanberkas', 'petugas.previewpasien', 'petugas.previewberkas']) }}">
                <a class="nav-link <?php echo $result4['status'] ?>" href="/petugas/laporanberkas">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <h4 class="h4 mb-0 text-gray-800">Peminjaman Berkas Poli Gigi</h4>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; 2022 Sisfo Peminjaman Berkas Poli Gigi RS Salamun - By Fitria Ramadhani Karim</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->

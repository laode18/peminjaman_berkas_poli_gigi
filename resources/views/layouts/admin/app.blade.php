...
<head>
    ...
    <title>Admin - Peminjaman Berkas Poli Gigi</title>
    <!-- Favicon icon -->
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" style="background: linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(43,43,255,1) 0%, rgba(0,212,255,1) 100%);" id="accordionSidebar">
            ...
            <li class="nav-item {{ set_active('admin.datadokter') }}">
                <a class="nav-link" href="/admin/datadokter">
                    <i class="fas fa-user-doctor"></i>
                    <span style="color: white;">&nbsp; Data Dokter</span></a>
            </li>

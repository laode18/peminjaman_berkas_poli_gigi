                        ...
                        <div class="col-xl-6 col-md-6 mb-4">
                            <div class="card border-left-success shadow h-100 py-2" style="background-color: royalblue;">
                                <div class="card-body">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-white text-uppercase mb-4"><h2>Jumlah Dokter</h2>
                                            </div>
                                            <br><br>
                                            <div class="h4 mb-0 font-weight-bold text-white">{{ count($dokter) }} Orang</div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-user-doctor fa-4x text-white"></i>
                                        </div>
                                    </div>
                                    </div>
                                </div>

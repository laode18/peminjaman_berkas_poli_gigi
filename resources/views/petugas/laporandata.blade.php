                                ...
                                <div class="card-body" style="height: 300px; text-align: center;">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="h4 mb-0 font-weight-bold text-white">
                                            <a href="/petugas/laporanberkas/previewpasien"><button class="bi bi-eye-fill editbtn btn btn-success col-xl-4 col-md-4 mb-2" style="font-size: 1.5rem; color:white;" role="button">&nbsp; Preview</button></a>
                                        </div>
                                    </div>
                                </div>
                                </div>
                            ...
                            <div class="card border-left-success shadow h-200 py-1" style="background-color: royalblue;">
                                <div class="card-body" style="height: 300px; text-align: center;">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <p>&nbsp;</p>
                                        <div class="h4 mb-0 font-weight-bold text-white">
                                            <a href="/petugas/laporanberkas/previewberkas"><button class="bi bi-eye-fill editbtn btn btn-success col-xl-4 col-md-4 mb-2" style="font-size: 1.5rem; color:white;" role="button">&nbsp; Preview</button></a>
                                        </div>
                                    </div>
                                </div>
                                </div>

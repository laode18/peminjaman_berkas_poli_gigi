...
<!-- Begin Page Content -->
                <div class="container">
                <h2 class="h4 mb-0 text-gray-800">Preview Data Berkas</h2>
                </div>
                <br>
                <br />
                <div class="container-fluid">
                	<a href="/laporanberkasrumahsakit">
                        <button class="bi bi-arrow-left-circle-fill btn" style="background-color: royalblue; color:white;"> Kembali</button>
                    </a>
                ...
                <table class="table table-bordered" style="text-align: center;">
                  ...
                  <tbody class="p1">
                    ...
                    <tr>
                      ...
                      <td>{{ $ps->diagnosa }}</td>
                      <td>{{ $ps->tindakan }}</td>
                      <td>{{ $ps->tanggal_berobat }}</td>
                      <td>{{ $ps->tanggal_pinjam }}</td>
